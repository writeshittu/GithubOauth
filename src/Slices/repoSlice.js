...
export const getRepos = createAsyncThunk("user", async () => {
  try {
    ...
    // );
    const response = await axios.get(
      `https://api.github.com/users/writeshittu/repos?per_page=20&sort=created:asc&client_id='c6458d61ad516ce425c3'&client_secret=a4bc61170fcffd03fd8cf75840cefee812875959`
    );
